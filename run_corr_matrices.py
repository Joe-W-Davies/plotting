...
def main(options):
    ...
    if options.varrs == 'SS':
        ...
        variables_corr  = ["probePt","probeScEta","probePhi",'rho','probeScEnergy','probeCovarianceIeIp_corr','probeS4_corr','probeR9_corr','probePhiWidth_corr','probeSigmaIeIe_corr','probeEtaWidth_corr']
        if options.final_reg: variables_corr = ["probePt","probeScEta","probePhi",'rho','probeScEnergy','probeCovarianceIeIp_corr_1Reg','probeS4_corr_1Reg','probeR9_corr_1Reg','probePhiWidth_corr_1Reg','probeSigmaIeIe_corr_1Reg','probeEtaWidth_corr_1Reg']
    elif options.varrs == 'Iso':
        variables      = ["probePt","probeScEta","probePhi",'rho','probeScEnergy','probePhoIso','probeChIso03','probeChIso03worst']
        variables_corr = ["probePt","probeScEta","probePhi",'rho','probeScEnergy','probePhoIso_corr','probeChIso03_corr','probeChIso03worst_corr']
        if options.final_reg: variables_corr = ["probePt","probeScEta","probePhi",'rho','probeScEnergy','probePhoIso_corr_1Reg','probeChIso03_corr_1Reg','probeChIso03worst_corr_1Reg']
    ...
    for corrMat in corrMatspt:
        ...
        corrMat.save('{}/{}'.format(os.getcwd(),options.outdir), options.varrs)
