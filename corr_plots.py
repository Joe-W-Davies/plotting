...
class corrMat:
    ...
    def save(self,outDir, corr_type):
        for fig,name in self.fig_name:
            name=name.replace(' ','_')
            name=name.replace('<','lt')
            name=name.replace('>','gt')
            fig.savefig(outDir + '/crl_' + name + corr_type + '.png',bbox_inches='tight')
            fig.savefig(outDir + '/crl_' + name + corr_type + '.pdf',bbox_inches='tight')
